package com.id124.retrocoffee.activity.customer.promote.adapter
...
import com.id124.retrocoffee.databinding.ItemProductPromoBinding
...
class PromoteAdapter : RecyclerView.Adapter<PromoteAdapter.RecyclerViewHolder>() {
    private lateinit var bind: ItemProductPromoBinding
